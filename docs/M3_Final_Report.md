...
| [최서현] | 설계자, QA/보안 |  | 전체적인 개발 일정을 조율하며 기술적 지연 요소를 조기에 발견하고 만회하는 관리 능력을 배울 수 있는 값진 한 학기였습니다. 비용 산정을 수행해보며 비용 예측의 중요성을 실감했고 설계 명세서와 클래스 다이어그램 구조를 바탕으로 코딩해보는 경험을 했습니다.|
